...
```xml
<ItemGroup>
  <PackageReference Include="PCLN.Plugin.Abstractions" Version="0.1.2" />
  <PackageReference Include="PCLN.Plugin.Sdk" Version="0.1.2" PrivateAssets="all" />
  <PackageReference Include="PCLN.Plugin.Analyzers" Version="0.1.2" PrivateAssets="all" />
  <PackageReference Include="PCLN.Plugin.Sdk.Build" Version="0.1.2" PrivateAssets="all" />
...
```xml
<PackageReference Include="PCLN.Plugin.UI" Version="0.1.2" />
```

需要创建完整 Avalonia 页面、窗口或申请 Raw Avalonia访问时，再加入：

```xml
<PackageReference Include="PCLN.Plugin.UI.Avalonia" Version="0.1.2" />
```
...
```xml
<PackageReference Include="PCLN.Plugin.Testing" Version="0.1.2" />
```
...
```xml
<PclNPluginSdkVersion>0.1.2</PclNPluginSdkVersion>
```
